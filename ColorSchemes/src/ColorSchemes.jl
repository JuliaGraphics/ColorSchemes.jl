...
function loadallschemes()
    ...
    include(joinpath(datadir, "cmasher.jl"))
    include(joinpath(datadir, "cmyt.jl"))
    ...
    include(joinpath(datadir, "paraview_fast.jl"))
    ...
    include(joinpath(datadir, "ltc.jl"))
    include(joinpath(datadir, "historical.jl"))
