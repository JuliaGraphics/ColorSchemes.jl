...

{
    ...
    "category": "section",
    "text": "The ColorSchemes module automatically provides a number of predefined schemes. All the colorschemes are stored in a dictionary, called colorschemes, which is exported."
},
...

{
    ...
    "category": "section",
    "text": "The pre-defined schemes shown in the following illustration. Each scheme is drawn in three ways: first, showing each color; next, a continuous blend obtained using get() with values ranging from 0 to 1 (stepping through the range 0:0.001:1); and finally a luminance graph shows how the luminance of the scheme varies as the colors change.It\'s generally agreed (search the web for \"Rainbow colormaps considered harmful\") that you should choose colormaps with smooth linear luminance gradients.(Image: \"all schemes\")(You can generate this image using ColorSchemes/docs/src/assets/figures/draw-swatches.jl, after obtaining the Luxor package to draw and label things.)colorschemes"
},
...

{
    ...
    "category": "section",
    "text": "ColorSchemes.jl provides the function getinverse(cscheme, c) which is the inverse of get(cscheme, x).This function returns a value between 0 and 1 that tries to place a color within a colorscheme by converting it to a value representing its position on the colorscheme\'s axis.(Image: \"get inverse\")"
},
