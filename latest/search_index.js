...

{
    ...
    "category": "section",
    "text": "ColorSchemes.jl provides a function, getinverse(cscheme, c), which is the inverse of get(cscheme, x).This function places a color within a colorscheme by converting the color to a value representing its position on the colorscheme's axis.(Image: \"get inverse\")"
},
...

{
    ...
    "category": "section",
    "text": "Using getinverse() it's easy to convert an image from one colorscheme to another.convert_to_scheme(cscheme, img) returns a new image in which each pixel from the provided image is mapped to its closest matching color in the provided scheme.convert_to_scheme(vcat(ColorSchemes.coffee, RGB(0,0,0)), img)(Image: \"heatmap 2 grey\")getinverse\nconvert_to_scheme"
},
